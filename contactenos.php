          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id=".navbar-collapse">
              <ul class="nav navbar-nav navbar-left">
                <li class="navlink"><a href="que-es-expobicipr.html">QUE ES EXPOBICIPR?</a></li>
    ...
    *****************************************************-->
	...
	<div class="slider-container"> 
		...
		<ul id="slider">
			...
			<li><a href="http://lakecycling.com/"><img src="../images/lake.png" class="img img-responsive" alt=""></a></li>
			<li><a href="http://kasalta.com"><img src="../images/kasalta.png" class="img-responsive" alt=""></a></li>
			<li><a href="http://yolorestaurantbar.com"><img src="../images/yolo.jpeg" class="img-responsive" alt=""></a></li>
		</ul>
	</div><!-- /slider -->
